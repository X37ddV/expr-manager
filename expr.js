        ...
        if (msg === "") {
            switch (t.tokenType) {
                ...
                case "VTK_SUBSCRIPT":
                    ...
                    break;
                case "VTK_FUNCTION":
                    if (p && p.tokenType === "TK_DOT" && p.childs[0] !== t) {
                        tv = lv.hashItem(rv);
                    }
                    else {
...
var ExprContext = (function (_super) {
    ...
    ExprContext.prototype.doGetFunctionType = function (name, source, paramType, paramData) {
        ...
        var r;
        var t; // 调用者类型，如"string","number","array","object"
        if (source !== null) {
    ...
    ExprList.prototype._doGetMode = function (updateList, l) {
        ...
        if (updateList && l && l.dependencies) {
            for (var i = 0; i < updateList.length; i++) {
                var u = updateList[i];
                for (var j = 0; j < l.dependencies.length; j++) {
                    if (u.fullName === l.dependencies[j]) {
                        ...
                        if (u.type === "U") {
                            ...
                            for (var k = 0; k < l.dependencies.length; k++) {
