...
var exprDataCalc = {
    ...
    //子实体、实体，单条数据
        ...
        ['Entity1[0]||Entity1[0].Parent()', 'undefined', 'object 无法做逻辑或运算的左运算数'],
    ...
    //子实体、实体，多条数据
        ...
        ['Entity2[0].Parent().Parent().E2[0].Entity1||Root().E2', 'undefined', 'array 无法做逻辑或运算的左运算数'],
        ['{Entity2[0].Parent().Parent().E2[0].Entity1:Root().E2}', 'undefined', ': 前不允许表达式存在'],
        ...
        ['Entity1.Average("ID")+""', 'undefined', 'number 和 string 无法做加法运算'], //10位,已改
        ['Entity1.Average("ID")+Entity1.Min("ID")', '203'],
        ['Root().E1.Average("P1")', 'undefined', 'string 和 number 无法做除法运算'],
        ...
        ['Root().E1[0].Entity1.Sum()', 'undefined', 'object 和 object 无法做加法运算'],
        ['Entity1.Sum("P2")', '6.85'],
        ...
        ['Entity1.Max()', 'undefined', 'object 和 object 无法做大于运算'],
        ...
        ['Entity1.Min("ID")', '101'],
        ['Entity1.Min()', 'undefined', 'object 和 object 无法做小于运算'],
        ['Entity1.Where()', 'undefined', 'array 没有名称为 Where 的方法或参数不匹配'],
        ...
        ['Entity1.Count()+Entity1.Average("ID").ToString()+Entity1.Sum("P1")+Entity1.Max("ID").ToString()+Entity1.Min("ID").ToString()', 'undefined', 'number 和 string 无法做加法运算'],
...
var exprString = {
    ...
    exprs: [
        ...
        ['"123"||"123"', 'undefined', 'string 无法做逻辑或运算的左运算数'],
        ['{"123":"123"}', '{"123":"123"}'],
...
var exprNumber = {
    ...
    exprs: [
        ...
        ['123.499||123.499', 'undefined', 'number 无法做逻辑或运算的左运算数'],
    ...
    //实体
        ...
        ['P2||P2', 'undefined', 'number 无法做逻辑或运算的左运算数'],
        ...
        ['Entity1[0].P2.Trunc(-1)', 'undefined', '做截断运算时，保留小数位数不能为负数: -1'], //
...
var exprDate = {
    ...
    exprs: [
        ...
        ['"1999-12-31".ToDate()||"1999-12-31".ToDate()', 'undefined', 'date 无法做逻辑或运算的左运算数'],
    ...
    //实体
        ...
        ['Root().E2[0].P5||Root().E2[0].P5', 'undefined', 'date 无法做逻辑或运算的左运算数'],
...
var exprObject = {
    ...
    //普通
        ...
        ['{d:Now()}||{a:1,b:"2",c:true,e:{a:[4,5,6],b:null}}', 'undefined', 'object 无法做逻辑或运算的左运算数'],
        ['{d:Now()} || {d:Now()}', 'undefined', 'object 无法做逻辑或运算的左运算数'],
        ['{a:1,b:"2",c:true,e:{a:[4,5,6],b:null}} || {a:1,b:"2",c:true,e:{a:[4,5,6],b:null}}', 'undefined', 'object 无法做逻辑或运算的左运算数'],
    ...
    //实体字段
        ...
        ['P3||Root().E2[0].P3', 'undefined', 'object 无法做逻辑或运算的左运算数'],
        ...
        ['Root().E2[0].P3.Parent()', 'undefined', '只有实体对象才可以调用 Parent 方法'],
        ['P3.name', '"item1"'],
        ['P3.alias.zh_CN', '"项目1"'],
    ]
};
var exprArray = {
    ...
    exprs: [
        ...
        ['[1,2,3.3]||["1","2","3"]', 'undefined', 'array 无法做逻辑或运算的左运算数'],
...
var exprNull = {
    ...
    //实体
        ...
        ['PN1+true', 'undefined', 'null 和 boolean 无法做加法运算'],
        ['PN1+{}', 'undefined', 'null 和 object 无法做加法运算'],
        ['PN1-PN1', 'null'],
        ['PN1-3', '-3'],
        ['PN1>PN1', 'false'],
        ['PN1>=PN1', 'true'], //?只等和不等
        ...
        ['\'PN1\'', '"PN1"'],
        ['PN1.ToString()', 'undefined', 'null 不能调用 ToString 方法'], //错误: '_func[...]' 为空或不是对象
        ['IfNull(PN1,PN1)', 'null'],
        ['IfNull("12",PN1)', '"12"'],
        ['IIf(true,"12", PN1)', '"12"'],
...
var exprErr = {
    ...
    //未定义属性
        ...
        ['Root().E2[0].tt', 'undefined', '属性不存在: tt'], //无error信息
